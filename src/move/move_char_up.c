...
void blanck_space_u(game_info_t *game_info)
{
...
void go_to_o_u(game_info_t *game_info)
{
    if (game_info->map_tab[game_info->player_pose->y + 1]\
    [game_info->player_pose->x] == 'O') {
        if (game_info->is_p_pos_o == 1) {
...
void move_a_block_u(game_info_t *game_info)
{
    if (game_info->map_tab[game_info->player_pose->y + 1]\
...
{
    blanck_space_u(game_info);
    go_to_o_u(game_info);
    move_a_block_u(game_info);
}